...
<head>
    <%-- 页面的字符集：
            浏览器加载一个jsp页面时如何选择编码格式：
            1、从响应报文的响应头中读取 Content-Type属性值，如果有则使用
            2、再从响应体内容中查找meta标签，获取charset属性值，如果有则使用
            3、如果没有获取到编码，浏览器使用它所在的操作系统默认的编码[GBK]
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="${PATH}/admin/login.html">登录</a></li>
                        <li><a href="${PATH}/admin/reg.html">注册</a></li>
                    </ul>
                </div>
            </div>
        </nav>
