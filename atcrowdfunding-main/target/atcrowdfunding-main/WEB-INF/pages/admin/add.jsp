        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="${PATH}/admin/save" method="post">
                        <div class="form-group">
                            <label for="exampleInputPassword1">登陆账号</label>
                            <input name="loginacct" type="text" class="form-control" id="exampleInputPassword" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="userpswd" type="text" class="form-control" id="exampleInputPassword2" placeholder="请输入用户密码">
                        </div>
                        <div class="form-group">
